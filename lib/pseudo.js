...
if ((/Chrome\/[1]?[0-9]\./.test(navigator.userAgent))) { // Chrome 1-19 indicated shadow proxy
  window.navigator.plugins = create(window.navigator.plugins.constructor, {length: 0});
  window.navigator.mimeTypes = create(navigator.mimeTypes.constructor, {length: 0});
  window.navigator.javaEnabled = function() { return false; };
    ...
    window.Date = function NewDate(param) {
    ...
    Math.random = function() {
      return 0.24942438531425257; // A versenyhelyzetek miatt nem jo a pseudo-random!
    };
